...
if (isset($_POST["clientNo"]))
{
	if($_POST["clientNo"]=="0")
	{
		echo('
    <form>
    <div class="button_box"><button class="large primary">Save</button><button class="large info">Cancel</button></div>
    <div display="inline">
        <label for="title">Name  </label><div id="title" class="input-control select size2">
        <select>
    ...
    <label for="refno">Reference Number</label><div id="refno" class="input-control text size3">
    ...
    $sql = "SELECT * FROM clients WHERE clients.ID=".$_POST["clientNo"];
